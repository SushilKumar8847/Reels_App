...
class UserProfileController extends ControllerMVC {
  ...
  void initState() {
    ...
    blockedUserScaffoldKey =
        new GlobalKey<ScaffoldState>(debugLabel: '_blockedUserScaffoldPage');
    scrollController = new ScrollController();
    super.initState();
  }
  ...
  fetchLoggedInUserInformation() async {
    ...
    print(
        "userValue.gender ${userValue.gender} ${userValue.gender.length} ${userValue.userName} ${userValue.name} ${userValue.email} ${userValue.mobile} ${userValue.bio}");
  ...
  Future<void> update() async {
    if (profRepo.usersProfileData.value.name.contains(" ")) {
      ...
      profRepo.usersProfileData.value.firstName =
          profRepo.usersProfileData.value.name;
  ...
  //       userRepo.blockedUsersData.value.users
