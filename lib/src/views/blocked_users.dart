                  ...
                  child: Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        var fullName = _user.users[i].firstName +
                            " " +
                            _user.users[i].lastName;
                        return Container(
                          ...
                          child: ListTile(
                            leading: Container(
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color:
                                      settingRepo.setting.value.dpBorderColor!,
                                ),
                            ...
                            trailing: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: settingRepo
                                        .setting.value.inactiveButtonColor,
                                    border: Border.all(
                    ...
                    child: SafeArea(
                      child: Scaffold(
                        ...
                        appBar: AppBar(
                          ...
                          backgroundColor:
                              settingRepo.setting.value.appbarColor,
                          leading: InkWell(
                            onTap: () {
