  ...
  void initState() {
    ...
    if (userRepo.socialUserProfile.value != null) {
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        print(
            "widget.email ${widget.email} widget.fullName ${widget.fullName}");
        // setState(() {
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                image: _con.selectedDp.path !=
                                                        null
                                                    ? FileImage(
                                                        _con.selectedDp,
                                                      )
                                                    : userRepo.socialUserProfile
                                                                    .value.userDP !=
                                                                '' &&
                                                            userRepo
                                                                    .socialUserProfile
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                TextFormField(
                                  ...
                                  keyboardType: TextInputType.text,
                                  validator: (input) {
                                    if (_con.profileDOBString == '' ||
                                        _con.profileDOBString == null) {
                                      ...
                                      onConfirm: (date) {
                                        _con.conDob
                                          ..text = _con.validDob(
                                              ...
                                              date.month.toString(),
                                              date.day.toString());
                                        _con.profileDOBString = _con.validDob(
                                            date.year.toString(),
                                            date.month.toString(),
                                            date.day.toString());
                                      },
                                    ...
                                    child: Align(
                                      ...
                                      child: DropdownSearch<Gender>(
                                        ...
                                        popupBackgroundColor:
                                            settingRepo.setting.value.bgShade,
                                        popupBarrierColor: settingRepo.setting
                                                    .value.dividerColor !=
                                                null
                                            ? settingRepo
