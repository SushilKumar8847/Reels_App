...
class _EditVideoState extends StateMVC<EditVideo>
  ...
  void initState() {
    ...
    setState(() {
      ...
      _con.descriptionTextController = new TextEditingController(
          text: Helper.removeAllHtmlTags(widget.video.description));
    });
                                  ...
                                  Expanded(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (_con.editVideoFormKey.currentState!
                                            .validate()) {
                                          _con.editVideo(
